...
# GRAFICA
nombre_grafica = 'paquetes_iniciales.pdf'
...
x4 = pcx4[0]    # alfa = 0
# print(x1, x2, x3, x4)
# ax.hlines(y=E0, xmin=x1, xmax=x2, lw=1.0, ls='-', color='k')
# ax.hlines(y=E0, xmin=x3, xmax=x4, lw=1.0, ls='-', color='k')
...
ax.set(title=r'$\left| \psi_1 \right> = \left( \left| \Phi_0 \right> + \left| \Phi_1 \right> \right)/\sqrt{2}$', ylabel=r'$E\ (\mathrm{cm^{-1}})$')
...
ax = axs[0][1]
# ==========================================
x1 = pcx1[len(pcx1)-1]    # alfa = 90
x2 = pcx2[len(pcx2)-1]    # alfa = 90
x3 = pcx3[len(pcx3)-1]    # alfa = 90
x4 = pcx4[len(pcx4)-1]    # alfa = 90
# print(x1, x2, x3, x4)
# ax.hlines(y=E2, xmin=x1, xmax=x2, lw=1.0, ls='-', color='k')
# ax.hlines(y=E2, xmin=x3, xmax=x4, lw=1.0, ls='-', color='k')
ax.plot(x, V, lw=1.3, color='gray')
# ax.plot(x, (dPsi2*multiplicador) + E2, label=r'$\left| \psi_2 \right|^2$')
ax.plot(x, (Psi2*multiplicador) + E2, label=r'$\left| \psi_2 \right>$')
ax.set_xlim(xmin,xmax)
ax.set_ylim(ymin,ymax)
ax.set(title=r'$\left| \psi_2 \right> = \left( \left| \Phi_2 \right> + \left| \Phi_3 \right> \right)/\sqrt{2}$')
ax.legend(loc='upper right')
# ==========================================
ax = axs[1][0]
# ==========================================
...
ax.set(ylabel=r'$E\ (\mathrm{cm^{-1}})$', xlabel=r'$x\ (\AA)$')
ax.set_xlim(xmin,xmax)
ax.set_ylim(ymin,ymax)
ax.legend(loc='upper right')
# ==========================================
