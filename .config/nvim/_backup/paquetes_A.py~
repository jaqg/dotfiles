...
ax.set(title=r'$\Psi = \left( \Phi_2 + \Phi_3 \right)/\sqrt{2}$', xlabel=r'$x\ (\AA)$')
ax.set_xlim(xmin,xmax)
ax.set_ylim(ymin,ymax)
ax.legend(loc='upper right')
...
ax.set(title=r'$\Psi = \left( \Phi_2 - \Phi_2 \right)/\sqrt{2}$', xlabel=r'$x\ (\AA)$')
ax.set_xlim(xmin,xmax)
ax.set_ylim(ymin,ymax)
ax.legend(loc='upper right')
